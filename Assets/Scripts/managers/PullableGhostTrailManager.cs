...
public class PullableGhostTrailManager : MonoBehaviour
{
    public static PullableGhostTrailManager obj;
    ...
    public void SetupGhostTrail(SpriteRenderer renderer, Transform mainTransform) {
        _renderer = renderer;
