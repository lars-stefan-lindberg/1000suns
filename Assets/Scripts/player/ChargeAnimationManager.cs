...
public class ChargeAnimationMgr : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        _fadeStartColor = _spriteRenderer.color;
    ...
    void LateUpdate()
    {
        if(_playerTransform == null && Player.obj != null)
            _playerTransform = Player.obj.transform;
        
        if(_playerTransform != null)
            transform.position = new Vector2(_playerTransform.position.x, _playerTransform.position.y + _playerOffset);
    }
}
